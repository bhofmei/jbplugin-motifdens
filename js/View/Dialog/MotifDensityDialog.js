...
function(
    ...
    return declare(ActionBarDialog, {
        ...
        show: function(/* callback */) {
            ...
            var topPane = domConstr.create('div',{id:'motif-dens-parameters'});
            this._createTopPane(topPane);

            var bottomPane = domConstr.create('div',{id:'moitf-dens-contexts'});
        ...
        _createTopPane: function(obj){
            ...
            var tblo = domConstr.create('table',{id:'motif-dens-tbl-param', className: 'motif-dens-dialog-tbl'}, obj);
            ...
            domConstr.create('span',{className: 'motif-dens-param-lbl', innerHTML: 'Window size (bp)'}, data0);
            ...
            // min density
            data2 = domConstr.create('td',{className: 'motif-dens-param-dens-col'}, row);
            domConstr.create('span',{className: 'mtoif-dens-param-lbl', innerHTML: 'Min. density'}, data2);
            ...
            // min density
            data2 = domConstr.create('td',{className: 'motif-dens-param-dens-col'}, row);
            domConstr.create('span',{className: 'motif-dens-param-lbl', innerHTML: 'Max. density'}, data2);
            data3 = domConstr.create('td',{}, row);
        ...
        _createBottomPane: function(obj){
            var thisB = this;
            var tblo = domConstr.create('table',{id:'motif-dens-tbl', className: 'motif-dens-dialog-tbl'}, obj);
            ...
            row = domConstr.create('tr', {}, tbl);
            data1 = domConstr.create('th',{innerHTML: "Sequence<br>Motif", rowspan:2}, row);
            data2 = domConstr.create('td',{id:'motif-dens-tbl-clrtype', className: 'motif-dens-tbl-clr-view-col', colspan: 2}, row);
            ...
            data2 = domConstr.create('td',{colspan: 3, className:'motif-dens-tbl-clr-view-col'}, row);
        ...
        _createRow: function(row, motif, cnt){
            ...
            data0 = domConstr.create('td',{class:'motif-dens-tbl-del-col'}, row);
            // delete button
            dbtn = new Button({
                '_index': cnt,
            ...
            // motif
            data1 = domConstr.create('td', {className: 'motif-dens-tbl-ctx-col'},row);
            ...
            data2 = domConstr.create('td',{className: 'motif-dens-tbl-clr-view-col'}, row);
            ...
            data3 = domConstr.create('td',{className: 'motif-dens-tbl-clr-col'},row);
            var clr = new TextBox({
                className: 'motif-dens-tbl-txt',
                value: clrHex,
                intermediateChanges: true,
        ...
        _createAddBtnRow: function(row){
            ...
            var thisB = this;
            var data0, dbtn;
            data0 = domConstr.create('td',{className: 'motif-dens-tbl-del-col'}, row);
            dbtn = new Button({
